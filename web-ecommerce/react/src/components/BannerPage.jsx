        ...
        <Box className="mt-3 grid grid-cols-1 gap-2 lg:grid-cols-6">
          <Box>
              <Box display="flex" flexDirection="column" height="100%">
                <Box flexGrow={1} display="flex"className="transition duration-500 group-hover:opacity-90" 
                  style={{ aspectRatio: "4 / 2" }}>
                  <Box textAlign="left">
                    <Box component="span" fontSize="1.3rem" fontWeight="bold" color="black">
                      2024's
                    </Box>
                    <br />
                ...
                <Box display="flex" alignItems="left" mt={1}>
                  <FaCircleChevronLeft style={{ color: 'gray', fontSize: '24px' }} />
                  <Box width="12px"/>
                  <FaCircleChevronRight style={{ color: 'gray', fontSize: '24px'  }} />
                </Box>
                <Box mt={1}>
                  <Link to="/DiscoverNow">
                    <Box component="span" fontSize="md" color="DodgerBlue" fontWeight="bold" textAlign="left" display="block">
                      FULL CATALOG &gt;
                    </Box>
                  </Link>
                </Box>
          ...
          <Box>
            <Link to="/DiscoverNow" className="group relative block">
              ...
              />
              <Box className="mt-1 text-center" fontSize="sm" fontWeight="bold">AUDIO</Box>
            </Link>
          </Box>
          ...
          <Box>
            <Link to="/DiscoverNow" className="group relative block">
              <img
                ...
                style={{ aspectRatio: "4 / 3" }}
              />
              <Box className="mt-1 text-center" fontSize="sm" fontWeight="bold">PREMIUM TV</Box>
            </Link>
          </Box>
          ...
          <Box>
            <Link to="/DiscoverNow" className="group relative block">
              <img
                ...
                style={{ aspectRatio: "4 / 3" }}
              />
              <Box className="mt-1 text-center" fontSize="sm" fontWeight="bold">GADGETS</Box>
            </Link>
          </Box>
          ...
          <Box>
            <Link to="/DiscoverNow" className="group relative block">
              <img
                ...
                style={{ aspectRatio: "4 / 3" }}
              />
              <Box className="mt-1 text-center" fontSize="sm" fontWeight="bold">TABLETS</Box>
            </Link>
          </Box>
          ...
          <Box>
            <Link to="/DiscoverNow" className="group relative block">
              <img
                ...
                style={{ aspectRatio: "4 / 3" }}
              />
              <Box className="mt-1 text-center" fontSize="sm" fontWeight="bold">HEADPHONES</Box>
            </Link>
          </Box>
        </Box>
      </Box>
